...
def veritabanini_yukle():
    with open('C:\\Users\\Kadircan\\Desktop\\Python\\AI Project\\veritabani.json', 'r') as dosya:
        return json.load(dosya)

def veritabanina_yaz(veriler):
    with open('C:\\Users\\Kadircan\\Desktop\\Python\\AI Project\\veritabani.json', 'w') as dosya:
...
def chat_bot():
    ...
    while True:
        ...
        if gelen_sonuc:
            ...
            print(f"Bot: Bunu nasıl cevaplayacağımı bilmiyorum. Öğretir misiniz?")
            yeni_cevap = input("Öğrenmek için yazabilir veya 'geç' diyebilirsiniz.")
